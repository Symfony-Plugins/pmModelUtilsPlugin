...
abstract class BaseArticlePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Title', 'Content', 'Status', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('title', 'content', 'status', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::TITLE, self::CONTENT, self::STATUS, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('title', 'content', 'status', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Title' => 0, 'Content' => 1, 'Status' => 2, 'Id' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('title' => 0, 'content' => 1, 'status' => 2, 'id' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::TITLE => 0, self::CONTENT => 1, self::STATUS => 2, self::ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('title' => 0, 'content' => 1, 'status' => 2, 'id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
